...
public class Call extends Instruction {
    ...
    public final int mDestinationAddressRegister;

    public Call(IContext context, int destinationAddressRegister) {
        super(context, "Call");
        mDestinationAddressRegister = destinationAddressRegister;
        mIncrementProgramCounter = false;
        trace("Call");
    }

    public void load() {
        mPipeline.setLoadRegister0(mContext.getRegisterBank().read(mDestinationAddressRegister));

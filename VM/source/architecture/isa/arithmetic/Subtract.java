...
public class Subtract extends AluInst {
    ...
    public Subtract(IContext context, boolean floatingPoint, int sourceReg1, int sourceReg2, int destinationReg) {
        super(context, floatingPoint, sourceReg1, sourceReg2, destinationReg, "Sub");
        trace("Sub " + sourceReg1 + " " + sourceReg2 + " " + destinationReg);
    }

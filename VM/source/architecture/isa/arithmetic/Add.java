...
public class Add extends AluInst {
    ...
    public Add(IContext context, boolean floatingPoint, int source1, int source2, int destination) {
        super(context, floatingPoint, source1, source2, destination, "Add");
        trace("Add " + mSourceReg1 + " " + mSourceReg2 + " " + destination);
    }

...
public class SubtractTest {
    ...
    public void subtract_integer() {
        ...
        Subtract subtract = new Subtract(mContext, false, 6, 7, 8);
        TestUtilities.runInstruction(subtract);
        Assert.assertEquals("Incorrent answer", -1, mRegisterBank.read(8));
    ...
    public void subtract_float() {
        ...
        Subtract subtract = new Subtract(mContext, true, 6, 7, 8);
        TestUtilities.runInstruction(subtract);
        Assert.assertEquals("Incorrent answer", Double.doubleToLongBits(-2.2), mRegisterBank.read(8));
        Mockito.verify(mContext, Mockito.never()).error(Mockito.anyLong());
    }
}
